...
public class ObstacleTable
{
    ...
    {
        reader.Seek(CaseTableAddress + (index - 4) * 4, SeekOrigin.Begin);
        Pointer casePtr = new Pointer(reader.ReadUInt32());
        // Read ASM code for case. The pointer to the object table is always 4 bytes after the instructions
