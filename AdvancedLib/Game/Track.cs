...
public class Track
{
    ...
    public AffineTilemap Tilemap { get; set; }
    public Tileset Minimap { get; set; }
    public Tileset ObstacleGfx { get; set; }
    public TrackObjects Objects { get; set; }
    public TrackAi Ai { get; set; }
    ...
    public Track()
    {
        ...
        Tilemap = new AffineTilemap(TrackConfig.Size.X * 128, TrackConfig.Size.Y * 128);
    ...
    private TrackDefinition LoadDefinition(Stream reader, int index)
    {
    ...
    private TrackHeader LoadHeader(Stream reader, int index)
    {
    ...
    private TrackConfig LoadConfig(TrackHeader header, TrackDefinition definition)
    {
    ...
    private Tileset LoadTileset(Stream reader, TrackHeader header, int headerIndex)
    {
    ...
    private AffineTilemap LoadTilemap(Stream reader, TrackHeader header)
    {
    ...
    private Tileset LoadMinimap(Stream reader, TrackHeader header)
    {
    ...
    private Tileset LoadObstacleGraphics(Stream reader, TrackHeader header, int headerIndex)
    {
        using var obstacleGraphicsStream = new MemoryPoolStream(256 * 32, true);
    ...
    private TrackObjects LoadObjects(Stream reader, TrackHeader header, int headerIndex)
    {
    ...
    private TrackAi LoadAi(Stream reader, TrackHeader header, TrackDefinition definition)
    {
    ...
    public void WriteTrack(Stream stream, int headerIndex)
    {
        ...
        WriteConfig(TrackConfig, ref trackDefinition, ref trackHeader);
    ...
    {
        byte[,] aiMap = Ai.GenerateZoneMap(header);
        ...
        for (int i = 0; i < trackObjects.ObstaclePlacements.Count; i++)
        {
            ...
            var objPlacement = new ObjectPlacement
            {
                ...
                Zone = aiMap[obsPlacement.Position.X, obsPlacement.Position.Y],
            };
        }
    }
